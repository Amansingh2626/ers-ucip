...
/**
 * ERSAddFAFProcessor is a processor for adding a new friend and family MSISDN to a specific subscriber account.
 * @author Jiraporn Yindeemoh
 *
 */
public class ERSAddFAFProcessor extends AbstractRequestProcessor<AccountVASOperationResponse>
{
	Logger logger = LoggerFactory.getLogger(ERSAddFAFProcessor.class);
	/**
	 * Subscriber account 
	...
	/**
	 * FAF number (MSISDN) wanted to add
	 */
...
//	private String reference;
	 ...
	 * @param reference
	 */
	public ERSAddFAFProcessor(Account subscriber, ERSHashtableParameter parameters, String reference, String nativeReference)
	{
...
//		this.reference = reference;
	 ...
	 * 2. Add FAF number using addToAccountFAF
	 * @return
	 */
	protected AccountVASOperationResponse _process()
	{
		...
		UCIPResponse ucipResponse = getConfig().getUcipAdaptor().getInstance().addToAccountFAF(subscriber.getAccountId(), fafNumber, nativeReference);
